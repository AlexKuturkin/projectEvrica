...
const mapHide = document.querySelector('.map__hide');
mapHide.addEventListener('mouseover', function () {
    mapHide.src = './images/свернуть hover.png';
});
mapHide.addEventListener('mouseout', function () {
    mapHide.src = './images/свернуть.png';
});